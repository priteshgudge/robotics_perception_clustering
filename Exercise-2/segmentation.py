...
def pcl_callback(pcl_msg):
    ...
    kd_tree, white_cloud = convert_to_kd_tree(extracted_outliers)
    print kd_tree
    cluster_indices = cluster_extraction_from_kd_tree(kd_tree, white_cloud)
    ...
    pcl_obj = pcl_to_ros(extracted_outliers)
    pcl_table = pcl_to_ros(extracted_inliers)
